...
import allpaths from "@/components/sundered-doctrine/assets/riddle-all.png";
import kerrev from "@/components/sundered-doctrine/assets/kerrev.png";
import { Truths } from "@/components/sundered-doctrine/components/Truths";

export const Route = createFileRoute("/sundered-doctrine")({
  component: SunderingDoctrine,
});

// glyph image source https://www.reddit.com/r/raidsecrets/comments/t7kea1/vow_callout_images_non_potato_quality/
function SunderingDoctrine() {
  return (
      ...
      <Accordion type="single" collapsible defaultValue="item-1">
        <AccordionItem value="item-1">
          ...
          <AccordionContent className="px-4">
            <img src={allpaths} alt="all paths" width={1000} />
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent className="px-4">
            <img src={kerrev} alt="Kerrev the Erased" width={1000} />
