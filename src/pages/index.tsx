    ...
    <>
      ...
      <main>
        ...
        <div className="m-14 grid grid-cols-1 items-start gap-y-8 gap-x-8 sm:mt-16 sm:gap-y-16 lg:gap-y-10 lg:mt-24 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
          ...
          <ul
            role="list"
            className="lg:col-span-2 xl:col-span-3 2xl:col-span-4 grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-y-10 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 [&:not(:focus-visible)]:focus:outline-none"
          >
            {tools.map((tool) => (
