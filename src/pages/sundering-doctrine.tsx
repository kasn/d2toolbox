...
export default function Home() {
    return <>
        ...
        <h2 className="m-3 dark:text-white text-xl">encounter 1</h2>
        <img src="/images/sd/IMG_5098.PNG" alt="" width={1000}/>        
        <h2 className="m-3 dark:text-white text-xl">encounter 2</h2>
        <h2 className="m-3 dark:text-white text-xl">encounter 3</h2>
